    ...
    <div className="space-y-8">
      ...
      <div className="grid  gap-8">
        ...
        <div className="space-y-6">
          <h3 className="text-2xl font-bold text-gray-800 mb-6">Category Analysis</h3>
          {categories.map((category, index) => {
            ...
            return (
              <motion.div
                ...
                className={`${getCategoryBgColor(score)} rounded-xl p-6 shadow-sm`}
              >
                ...
                {score < 80 && recommendations.filter(rec => 
                  ...
                  <div className="mt-4">
                    <h6 className="font-medium text-gray-700 mb-2">Recommendations for {category.name}:</h6>
        ...
        <div className="space-y-6">
          <h3 className="text-2xl font-bold text-gray-800 mb-6">Best Practices & Tips</h3>
...
const ATSChecker = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-start justify-center bg-gradient-to-br from-[#f5f7fa] via-[#d7f5ef] to-[#e6e0f8]">
      <div className="max-w-7xl w-full flex flex-col lg:flex-row gap-8 px-6 py-12">
        ...
        <div className="flex-1 flex flex-col justify-start max-w-xl">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 leading-tight mb-4">Is your resume good enough?</h1>
          ...
          <form onSubmit={handleSubmit}>
            <div className="bg-white/80 border border-dashed border-[#38d9a9] rounded-2xl p-8 shadow-sm max-w-lg">
              <div className="text-center text-gray-700 mb-4">
                Drop your resume here or choose a file.<br />
                <span className="text-gray-500 text-sm">PDF &amp; DOCX only. Max 2MB file size.</span>
              </div>
              <label className="flex flex-col items-center justify-center cursor-pointer">
                <input type="file" className="hidden" accept=".pdf,.doc,.docx" onChange={handleFileChange} />
                <div className="flex flex-col items-center justify-center w-full py-4">
                  <FiUpload className="w-8 h-8 text-[#38d9a9] mb-2" />
                  <span className="text-[#38d9a9] font-semibold">Upload Your Resume</span>
                </div>
              </label>
              {file && (
                <div className="mt-2 text-sm text-gray-600 text-center">Selected: {file.name}</div>
              )}
              <button type="submit" className="mt-4 w-full bg-[#38d9a9] text-white font-semibold py-2 rounded-lg hover:bg-[#20bfa9] transition">{loading ? 'Analyzing...' : 'Analyze Resume'}</button>
              <div className="mt-4 text-xs text-gray-400 text-center">&#128274; Privacy guaranteed</div>
        ...
        <div className="flex-1 flex flex-col space-y-8">
          {result && (
            <>
              {/* ATS Score Display */}
              <div className="bg-white/80 border border-dashed border-[#38d9a9] rounded-2xl p-8 shadow-sm">
                <div className="flex flex-col items-center justify-center">
                  <div className="mb-4">
                    <Gauge value={result.ats_score ?? 0} />
                  </div>
                  <div className="text-5xl font-extrabold text-[#38d9a9] mb-2">{result.ats_score ?? 0}/100</div>
                  <div className="text-lg font-semibold text-gray-700 mb-1">ATS Score</div>
                  <div className="text-sm text-gray-500">Your resume's ATS compatibility</div>
                </div>
              </div>

              {/* Category Analysis moved here */}
              ...
              {result?.additional_analysis && (
                <div className="bg-white/80 rounded-2xl p-8 shadow-sm mt-8">
                  <h3 className="text-2xl font-bold text-gray-800 mb-6">Detailed Resume Analysis</h3>
                  <div className="grid gap-6">
                    {/* Skills Analysis */}
                    {result.additional_analysis.skills && (
                      ...
                      >
                        <h4 className="text-lg font-semibold text-gray-800 mb-4">Skills Analysis</h4>
                    ...
                    {result.additional_analysis.experience && (
                      <motion.div
                        ...
                        className="bg-white rounded-xl p-6 shadow-sm"
                      >
                        <h4 className="text-lg font-semibold text-gray-800 mb-4">Experience Analysis</h4>
                        <div className="space-y-4">
                    ...
                    {result.additional_analysis.education && (
                      <motion.div
                        ...
                        className="bg-white rounded-xl p-6 shadow-sm"
                      >
                        <h4 className="text-lg font-semibold text-gray-800 mb-4">Education Analysis</h4>
                        <div className="space-y-4">
                    ...
                    {result.additional_analysis.keywords && (
                      <motion.div
                        ...
                        className="bg-white rounded-xl p-6 shadow-sm"
                      >
                        <h4 className="text-lg font-semibold text-gray-800 mb-4">Keyword Optimization</h4>
                        <div className="space-y-4">
                    ...
                    {result.additional_analysis.career_progression && (
                      <motion.div
                        ...
                        className="bg-white rounded-xl p-6 shadow-sm"
                      >
                        <h4 className="text-lg font-semibold text-gray-800 mb-4">Career Progression</h4>
                        <div className="space-y-4">
